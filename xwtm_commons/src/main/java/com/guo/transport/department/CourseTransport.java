 ...
 * 类描述：课程信息信息传输层接口
 *
 * @ClassName CourseTransport
 * @Description 课程信息信息传输层接口
 * @Author 郭佳
...
public interface CourseTransport {
	 ...
	 */
	@PostMapping("/id")
	Course getCourseById(@RequestParam String id) throws Exception;
	 ...
	 */
	@PostMapping("/queryvo")
	PageVo<Course> getPageVoByQuery(@RequestBody QueryVo<Course> queryVo) throws Exception;
	 ...
	 */
	@PostMapping("/query")
	List<Course> getListByQuery(@RequestBody Course query) throws Exception;
	 ...
	 */
	@PostMapping("/save")
	boolean save(@RequestBody Course entity) throws Exception;
	 ...
	 */
	@PostMapping("/update")
	boolean update(@RequestBody Course entity) throws Exception;
